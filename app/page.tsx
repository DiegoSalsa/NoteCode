...
export default function DashboardPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const [projRes, credRes, invRes] = await Promise.all([
                ...
                const pending = invData.filter((i: { status: string }) => i.status === "Pendiente");
        ...
        <div className="mx-auto max-w-5xl px-8 py-10 space-y-14">
            ...
            <section className="space-y-2">
                <h1 className="text-[28px] font-bold tracking-tight text-neutral-100">
                    Bienvenido a PuroCode
                </h1>
                <p className="text-[15px] text-neutral-400 leading-relaxed max-w-2xl">
                    Centro de control de la agencia. Gestiona proyectos, notas y
                    credenciales desde un solo lugar.
                </p>
            </section>
